...
namespace JohnsonNet.Data
{
    ...
    public class ResultSet<T, T1, T2> : ResultSet<T, T1>
    {
    ...
    public class ResultSet<T, T1, T2, T3> : ResultSet<T, T1, T2>
    {
    ...
    public class ResultSet<T, T1, T2, T3, T4> : ResultSet<T, T1, T2, T3>
    {
    ...
    public class ResultSet<T, T1, T2, T3, T4, T5> : ResultSet<T, T1, T2, T3, T4>
    {
    ...
    public class ResultSet<T, T1, T2, T3, T4, T5, T6> : ResultSet<T, T1, T2, T3, T4, T5> 
    {
    ...
    public class ResultSet<T, T1, T2, T3, T4, T5, T6, T7> : ResultSet<T, T1, T2, T3, T4, T5, T6>
    {
    ...
    public class ResultSet<T, T1, T2, T3, T4, T5, T6, T7, T8> : ResultSet<T, T1, T2, T3, T4, T5, T6, T7>
    {
    ...
    public class ResultSet<T, T1, T2, T3, T4, T5, T6, T7, T8, T9> : ResultSet<T, T1, T2, T3, T4, T5, T6, T7, T8>
    {
